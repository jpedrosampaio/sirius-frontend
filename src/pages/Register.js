    ...
    <div className="min-h-screen bg-[#050505] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-[#888888]">Junte-se ao sistema de comando</p>
        </div>
          ...
          <form onSubmit={handleRegister} className="space-y-6">
            <div>
              ...
              <div className="relative">
                <User className="absolute left-3 top-3 w-5 h-5 text-[#555555]" />
                <Input
                  id="name"
            ...
            <div>
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-[10px] text-[#555555] bg-[#1a1a1a] px-1.5 py-0.5 rounded">(Opcional)</span>
                <a
                  href="https://a.co/apikey-guide"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-[#555555] hover:text-[#00c896] transition-colors"
