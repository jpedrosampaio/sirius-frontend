...
function AnimatedNumber({ end, label }) {
  ...
  return (
    <div ref={ref} className="text-center">
      <p className="font-heading text-3xl sm:text-4xl text-[#00c896]">{count}+</p>
      <p className="text-xs text-[#555555] uppercase tracking-wider mt-1">{label}</p>
    </div>
  );
}
...
function ModuleCard({ icon, name, desc, color }) {
  const Icon = icon;
  return (
    <div className="group bg-[#0d0d0d] border border-[#1A1A1A] hover:border-[#333] p-5 sm:p-6 rounded-lg transition-all duration-300 hover:-translate-y-0.5 cursor-default">
  ...
  return (
    <div className={"flex flex-col gap-10 lg:gap-16 items-center " + (reversed ? "lg:flex-row-reverse" : "lg:flex-row")}>
      <div className="flex-1 space-y-5">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-[#2a2a2a] bg-[#0d0d0d]">
...
const MODULES = [
  { icon: CheckCircle2, name: "Tarefas", desc: "Organize e execute com precisão", color: "#00c896" },
  { icon: TrendingUp, name: "Hábitos", desc: "Construa streaks inquebráveis", color: "#00c896" },
  ...
  { icon: MessageSquare, name: "Assistente IA", desc: "Chat inteligente com Gemini", color: "#00c896" },
...
export default function Landing() {
  ...
  const rankColor = (i) => {
    if (i === 0) return "bg-[#555555] text-white";
    if (i < 4) return "bg-[#00c896]/20 text-[#00c896] border border-[#00c896]/30";
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white overflow-x-hidden">
      {/* NAV */}
      <nav className={"fixed w-full top-0 z-50 transition-all duration-300 " + (scrolled ? "bg-[#0d0d0d]/90 backdrop-blur-xl border-b border-[#2a2a2a] shadow-lg shadow-black/20" : "bg-transparent")}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex justify-between items-center">
          <div className="flex items-center space-x-2 cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}>
            <SiriusLogo size="w-8 h-8" />
            <span className="font-heading text-2xl bg-gradient-to-r from-[#00c896] to-[#00c896] bg-clip-text text-transparent">SIRIUS</span>
          </div>
          <div className="hidden md:flex items-center space-x-6">
            <a href="#modules" className="text-sm text-[#888888] hover:text-white transition-colors">Módulos</a>
            <a href="#details" className="text-sm text-[#888888] hover:text-white transition-colors">Destaques</a>
            <a href="#gamification" className="text-sm text-[#888888] hover:text-white transition-colors">Gamificação</a>
          </div>
          <div className="flex items-center space-x-3">
            <Button data-testid="landing-login-btn" variant="ghost" onClick={() => navigate("/login")} className="text-sm text-[#888888] hover:text-white">
              Login
            </Button>
            <Button data-testid="landing-register-btn" onClick={() => navigate("/register")} className="bg-[#00c896] hover:bg-[#0062CC] text-sm shadow-[0_0_20px_rgba(0,122,255,0.3)]">
              Começar Grátis
            </Button>
          </div>
        </div>
      ...
      <section className="relative pt-28 pb-20 sm:pt-36 sm:pb-28 px-4 overflow-hidden">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full bg-[#00c896]/5 blur-[120px]" />
          <div className="absolute bottom-0 left-1/4 w-[400px] h-[400px] rounded-full bg-[#00c896]/5 blur-[100px]" />
          <div className="absolute top-0 right-0 w-[300px] h-[300px] rounded-full bg-[#A855F7]/5 blur-[80px]" />
        </div>
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <FadeIn>
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-[#2a2a2a] bg-[#0d0d0d]/80 backdrop-blur-sm mb-8">
              <Sparkles className="w-4 h-4 text-[#00c896]" />
              <span className="text-xs text-[#888888] uppercase tracking-wider">Powered by Google Gemini AI</span>
            </div>
          </FadeIn>
          <FadeIn delay={100}>
            <h1 className="font-heading text-5xl sm:text-6xl lg:text-8xl mb-6 tracking-tight leading-[0.9]">
              ...
              <span className="block bg-gradient-to-r from-[#00c896] via-[#00c896] to-[#A855F7] bg-clip-text text-transparent">É DESTINO</span>
            </h1>
          </FadeIn>
          <FadeIn delay={200}>
          ...
          <FadeIn delay={300}>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button data-testid="landing-start-btn" size="lg" onClick={() => navigate("/register")} className="bg-[#00c896] hover:bg-[#0062CC] h-14 px-10 text-base font-medium shadow-[0_0_30px_rgba(0,122,255,0.4)] transition-all group">
                Iniciar Missão
                <ArrowRight className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" />
              </Button>
              <Button variant="outline" size="lg" onClick={() => document.getElementById("modules")?.scrollIntoView({ behavior: "smooth" })} className="h-14 px-10 text-base border-[#2a2a2a] hover:bg-[#1a1a1a] text-[#888888] hover:text-white">
                Ver Funcionalidades
              </Button>
            </div>
          </FadeIn>
      ...
      <section id="modules" className="py-20 px-4 relative">
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-[#0d0d0d]/50 to-transparent pointer-events-none" />
        <div className="max-w-7xl mx-auto relative z-10">
          <FadeIn>
            <div className="text-center mb-14">
              <p className="text-xs text-[#00c896] uppercase tracking-[0.3em] mb-3 font-medium">Ecossistema Completo</p>
              <h2 className="font-heading text-4xl sm:text-5xl">TUDO EM UM SÓ LUGAR</h2>
              <p className="text-[#888888] mt-4 max-w-xl mx-auto">12 módulos integrados que conversam entre si. Seus dados de treino influenciam suas metas de nutrição. Seus estudos geram XP. Tudo conectado.</p>
            </div>
          </FadeIn>
      ...
      <section id="gamification" className="py-20 px-4 relative">
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-[#00c896]/[0.03] to-transparent pointer-events-none" />
        <div className="max-w-5xl mx-auto relative z-10">
          <FadeIn>
            <div className="text-center mb-14">
              ...
              <p className="text-[#888888] mt-4 max-w-xl mx-auto">Cada ação gera XP. Suba de rank, de Recruta a Marechal. 14 níveis para conquistar.</p>
            </div>
          </FadeIn>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
            <FadeIn delay={0}>
              <div className="bg-[#0d0d0d] border border-[#1A1A1A] rounded-xl p-7 text-center hover:border-[#FFD700]/30 transition-colors">
                ...
                <p className="text-sm text-[#555555]">Tarefas, hábitos, treinos, estudos — tudo gera pontos de experiência</p>
              </div>
            </FadeIn>
            <FadeIn delay={100}>
              <div className="bg-[#0d0d0d] border border-[#1A1A1A] rounded-xl p-7 text-center hover:border-[#00c896]/30 transition-colors">
                <div className="w-14 h-14 mx-auto mb-4 rounded-full bg-[#00c896]/10 flex items-center justify-center">
                  <Award className="w-7 h-7 text-[#00c896]" />
                </div>
                <h4 className="font-heading text-xl mb-2">SUBA DE RANK</h4>
                <p className="text-sm text-[#555555]">De Recruta a Marechal — 14 patentes inspiradas na hierarquia militar</p>
              </div>
            </FadeIn>
            <FadeIn delay={200}>
              <div className="bg-[#0d0d0d] border border-[#1A1A1A] rounded-xl p-7 text-center hover:border-[#00c896]/30 transition-colors">
                <div className="w-14 h-14 mx-auto mb-4 rounded-full bg-[#00c896]/10 flex items-center justify-center">
                  <Flame className="w-7 h-7 text-[#00c896]" />
                </div>
                <h4 className="font-heading text-xl mb-2">MANTENHA STREAKS</h4>
                <p className="text-sm text-[#555555]">Sequências de dias produtivos que multiplicam seus ganhos de XP</p>
              </div>
            </FadeIn>
          </div>
          <FadeIn delay={300}>
            <div className="mt-10 bg-[#0d0d0d] border border-[#1A1A1A] rounded-xl p-6 sm:p-8">
              <p className="text-xs text-[#555555] uppercase tracking-wider mb-4 text-center">Progressão de Ranks</p>
              <div className="flex items-center justify-between overflow-x-auto gap-1 pb-2">
                {RANKS.map((rank, i) => (
                  <div key={rank} className="flex flex-col items-center min-w-[60px]">
                    ...
                    <span className="text-[8px] text-[#555555] mt-1.5 text-center leading-tight">{rank}</span>
                  </div>
                ))}
              </div>
            </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <FadeIn>
            <div className="relative bg-gradient-to-br from-[#00c896]/10 via-[#0d0d0d] to-[#A855F7]/10 border border-[#1A1A1A] rounded-2xl p-8 sm:p-12 overflow-hidden">
              <div className="absolute top-0 right-0 w-[300px] h-[300px] rounded-full bg-[#00c896]/5 blur-[80px] pointer-events-none" />
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#00c896] to-[#A855F7] flex items-center justify-center">
                    <Brain className="w-6 h-6 text-white" />
                  </div>
                  <div>
                    <h3 className="font-heading text-2xl">ASSISTENTE IA INTEGRADO</h3>
                    <p className="text-xs text-[#555555]">Powered by Google Gemini 2.5 Flash</p>
                  </div>
                </div>
                <p className="text-[#888888] mb-8 leading-relaxed max-w-2xl">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {[
                    ...
                    <div key={i} className="flex items-center gap-3 bg-[#050505]/60 border border-[#2a2a2a] rounded-lg px-4 py-3">
                      <MessageSquare className="w-4 h-4 text-[#00c896] flex-shrink-0" />
        ...
        <div className="max-w-3xl mx-auto text-center">
          <FadeIn>
            <h2 className="font-heading text-4xl sm:text-5xl lg:text-6xl mb-6">
              PRONTO PARA A
              <span className="block bg-gradient-to-r from-[#00c896] to-[#00c896] bg-clip-text text-transparent">MISSÃO?</span>
            </h2>
            ...
            <Button size="lg" onClick={() => navigate("/register")} className="bg-[#00c896] hover:bg-[#0062CC] h-14 px-12 text-base font-medium shadow-[0_0_40px_rgba(0,122,255,0.4)] transition-all group">
      ...
      <footer className="border-t border-[#1A1A1A] py-10 px-4">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-heading text-lg bg-gradient-to-r from-[#00c896] to-[#00c896] bg-clip-text text-transparent">SIRIUS</span>
          </div>
          <p className="text-xs text-[#333333]">© 2025 Sirius — Discipline is Destiny. Todos os direitos reservados.</p>
